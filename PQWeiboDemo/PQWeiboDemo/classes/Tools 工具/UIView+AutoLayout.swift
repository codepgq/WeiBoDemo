...
extension UIView {
    ...
    */
    public func pq_HorizontalTile(views: [UIView], insets: UIEdgeInsets) -> [NSLayoutConstraint] {
        ...
        for i in 1..<views.count {
            let subView = views[i]
            cons += subView.pq_sizeConstraints(firstView)
    ...
    */
    ...
    :returns: 约束数组
    */
    private func pq_AlignLayout(referView: UIView, attributes: PQ_LayoutAttributes, size: CGSize?, offset: CGPoint) -> [NSLayoutConstraint] {
